...
contract CrowdFunding {
    ...
    uint256 _deadline, string memory _image) public returns (uint256){
        Campaing storage campaign = campaings[numberOfCampaigns];
    ...
    function donateToCampaign(uint256 _id) public payable {
        ...
        Campaing storage campaign = campaings[_id];
    ...
    function getCampaigns() public view returns(Campaing[] memory) {
        Campaing[] memory allCampaigns = new Campaing[](numberOfCampaigns);
